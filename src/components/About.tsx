      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            ...
            workshops, internet, library, and expert human capital. The cell
            also connects incubates with a strong network of professionals,
            academicians, investors, and an advisory board to support and guide
            innovative ventures.
          </p>
        </div>
